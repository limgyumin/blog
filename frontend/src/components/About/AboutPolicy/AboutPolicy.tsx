...
const AboutPolicy: React.FC<Props> = () => {
  return (
    <Container>
      <Section>
      ...
      <Section>
        ...
        <List>
          <Item>개인정보를 제공받는 자 : 임규민</Item>
          <Item>
            제공받는 자의 개인정보 이용목적 : 이름, 서비스 이용 기록, GitHub
            사용자 아이디
          </Item>
          <Item>제공받는 자의 보유·이용기간 : 영구</Item>
        </List>
        <Content>
      ...
      <Section>
        ...
        <Content>회사는 다음의 개인정보 항목을 처리하고 있습니다.</Content>
        <List>
          <Item>필수항목 : 이름, 서비스 이용 기록, GitHub 사용자 아이디</Item>
        </List>
      </Section>
      <Section>
      ...
      <Section>
        <Title>7. 개인정보 보호책임자 작성 </Title>
        <Content>
          1) 회사는 개인정보 처리에 관한 업무를 총괄해서 책임지고, 개인정보
          처리와 관련한 정보주체의 불만처리 및 피해구제 등을 위하여 아래와 같이
          개인정보 보호책임자를 지정하고 있습니다.
        </Content>
        <Subtitle> 개인정보 보호책임자</Subtitle>
        <List>
          <Item>성명 : 임규민</Item>
          <Item>연락처 : dev.limgyumin@gmail.com</Item>
        </List>
        <Content>
